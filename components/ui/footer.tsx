        ...
        >
          ...
          <div className="space-y-2 sm:col-span-12 lg:col-span-4">
            <div className="text-sm text-gray-600">
              &copy; WAIFU Project - All rights reserved.
            </div>
          </div>
     
          {/* 5th block */}
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2 float-right">
            <ul className="flex gap-1">
              <li>
                <Link
                  className="flex items-center justify-center text-blue-500 transition hover:text-blue-600"
                  href="https://x.com/thewaifuproject/"
                  target="_blank"
                  aria-label="Twitter"
                >
                  <svg
              ...
              <li>
                <Link
                  className="flex items-center justify-center text-blue-500 transition hover:text-blue-600"
                  href="https://mirror.xyz/uxbro.eth"
                  target="_blank"
                  aria-label="Medium"
                >
                  <svg
              ...
              <li>
                <Link
                  className="flex items-center justify-center text-blue-500 transition hover:text-blue-600"
                  href="https://github.com/The-WAIFU-Project"
                  target="_blank"
                  aria-label="Github"
                >
                  <svg
